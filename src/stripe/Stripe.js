...
const Card =(props)=>{
    ...
    <button className="btn-pagar" role="link" onClick={props.pagar} data-price={props.idPrecio} >PagarP</button>
...
const Stripe = () =>{
    ...
    precio: "2500000"},{idPrecio: "price_1J93xIJVTSqA0wgZah4XTnIx",
    idProduct: "prod_JmdDpKWuFXWPPo",
    img: "https://files.stripe.com/links/MDB8YWNjdF8xSjkzcFFKVlRTcUEwd2dafGZsX3Rlc3RfM0tHRjBpTkcyNVo1aGN6MTVQWE0xY3FR00yRAdtgke",
    moneda: "mxn",
    name: "Bebida Arroz",
    precio: "1200000"}])
    ...
    document.addEventListener("click" ,e =>{
        if(!e.target.matches(".guajolote button")) return console.log("diferente")

        localStorage.setItem("keyPrice",e.target.dataset.price)
    })
    ...
    const handleClick = async (props) =>{
        ...
        const { error } = await stripe.redirectToCheckout({
            lineItems: [{
                price:localStorage.getItem("keyPrice"),
                quantity:2,
            },],
            mode:"payment",
...
/* [{idPrecio: "price_1J93ufJVTSqA0wgZMD8FilhH",
    idProduct: "prod_JmdBI9FhTGiM6H",
    img: "https://files.stripe.com/links/MDB8YWNjdF8xSjkzcFFKVlRTcUEwd2dafGZsX3Rlc3RfSG5pcUpBQkhaV1c1YzVTZmJGTXZWN2Nk00btvfHrjd",
    moneda: "mxn",
    name: "guajolota Verde",
    ...
    /* <button  onClick={handleClick} disabled={loading}>ir a pagar</button> */